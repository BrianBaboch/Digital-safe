...
def main():
    ...
    while True:
        ...
        if choice == 1:
            ...
            try:
                res = str(input("Entrez l'ID de la ressource que vous souhaitez avoir : "))
                print("\n")
            except:
...
def request_info():
    ...
    i = 1
    print("You have access to the following ressources:\n")
    for k in result:
        print("Ressource ID: " + str(k[0]))
        print("Description: " + str(k[1]))
        print("Accessible on: " + str(k[3]))
        print("Valid until: " + str(k[4]))
        print("\n")
        i+=1
...
def request_access(key):
    ...
    if(str(result) == "00"):
        ...
        print("The ressource you chose doesn't exist.")
        return
    elif(str(result) == "0"):
